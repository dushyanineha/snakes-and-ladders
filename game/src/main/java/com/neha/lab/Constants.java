...
public class Constants {
    ...
    public static final int CANVAS_WIDTH = 700; // Board width

    public static final int CANVAS_HEIGHT = 700; // Board height

    public static final int NUMBER_OF_ROWS = 10; // rows in grid

    public static final int NUMBER_OF_COLS = 10; // columns in grid
